...
from worker_backend.vnc_manager import VNCInstance, VNCManager
...
def test_get_status_stopped():
    from worker_backend.browser_manager import BrowserManager
    mgr = BrowserManager()
...
def test_get_status_running():
    from worker_backend.browser_manager import BrowserManager, RunningProfile
